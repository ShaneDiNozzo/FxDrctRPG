class Encounter {
  ...
  EasyEncounter() {
    ...
    if(random === 1) {
      this.monster = new Character("Gralie", Randoms.MaxMin(10, 7),
  ...
  NormalEncounter() {
    ...
    if(random === 1) {
      this.monster = new Character("Red Gralie", Randoms.MaxMin(18, 15),
        Randoms.MaxMin(5, 1), Randoms.MaxMin(9, 7), this.imgs.redgarile);
    } else if(random === 2) {
      this.monster = new Character("Torglo Warrior", Randoms.MaxMin(18, 15),
